...
// Permissions
define("_DIRMODE", '755');							//permission sur les répertoires après le deploiement 755 en règle générale 
define("_FILEMODE", '644');							//permission sur les fichiers après le deploiement 644 en règle générale
