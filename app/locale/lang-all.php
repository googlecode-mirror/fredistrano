<?php
/**
 * This file can be managed by lang_tools.php
 *
...
$msg =   array (
	...
	'autologarchive' =>  array (
		'fr-FR' => "Archivage automatique de %d log(s)",
		'en-US' => "Archivage automatique de %d log(s)"
	),
	'back' =>  array (
		'fr-FR' => "retour",
		'en-US' => "back"
	...
	'correcterrorsbelow' =>  array (
		...
		'en-US' => "Please correct errors below."
	),
	'coupdated' =>  array (
	...
	'enterapplicationdirectory' =>  array (
		...
		'en-US' => "Please enter the folder of the application on the production server"
	),
	'enterproductionurl' =>  array (
		'fr-FR' => "Veuillez saisir l'url de l'application sur le serveur de production.",
		'en-US' => "Please enter the production url for this project."
	),
	'enterprojectname' =>  array (
		'fr-FR' => "Veuillez saisir un nom de projet.",
		'en-US' => "Please enter a project name."
	),
	'enterurlrepositoryforthisproject' =>  array (
		'fr-FR' => "Veuillez saisir l'url du repository pour ce projet",
		'en-US' => "Please enter the repository url for this project."
	),
	...
	'groupdeleted' =>  array (
		'fr-FR' => "Groupe supprimé.",
		'en-US' => "Group deleted."
	),
	'grouplist' =>  array (
		'fr-FR' => "Liste des groupes",
		'en-US' => "Groups list"
	),
	'groups' =>  array (
		'fr-FR' => "Groupes",
	...
	'identificationaccepted' =>  array (
		...
		'en-US' => "Identification accepted."
	),
	'identificationwrong' =>  array (
	...
	'invalidlogid' =>  array (
		'fr-FR' => "Identifiant de log inconnu => ",
		'en-US' => "Invalid log id => "
	),
	'invalidprojectid' =>  array (
	...
	'projectnamealreadyexists' =>  array (
		...
		'en-US' => "The project name is already in use."
	),
	'projects' =>  array (
		'fr-FR' => "Projets",
		'en-US' => "Projects"
	...
	'projectsaved' =>  array (
		'fr-FR' => "Projet sauvegardé.",
		'en-US' => "The Project has been saved."
	),
	'projectslist' =>  array (
	...
	'usercreated' =>  array (
		'fr-FR' => "Utilisateur créé.",
		'en-US' => "User created."
	),
	'userdeleted' =>  array (
		'fr-FR' => "Utilisateur supprimé.",
		'en-US' => "User deleted."
	),
	'userlist' =>  array (
