...
/**
 * A valid optional email address.
 */
	define('VALID_EMAIL_OPTIONAL', '/\\A(?:^|([a-z0-9][a-z0-9_\\-\\.\\+]*)@([a-z0-9][a-z0-9\\.\\-]{0,63}\\.(com|org|net|biz|info|name|net|pro|aero|coop|museum|[a-z]{2,4}))$)\\z/i');
